...
<p align=justify>
@NCHS is a new mobile application developed for students at North Creek High School. The primary goal of @NCHS is to provide a streamlined platform for students at North Creek High School that encompasses current and future utilization of technology on campus. Consistent with the Future Business Leaders of America (FBLA) Mobile Application Development </p> [competetive event guidelines](https://www.fbla-pbl.org/media/2022/03/FBLA21001_CE_guidelines_FBLA_v2.pdf) 
<p align=justify>
